      ...
      children: [
          ...
          Container(
              ...
              child: Row(
                ...
                children: [Text('Campos Eliseos, Brasil'), Icon(Icons.hourglass_bottom)],
              )),
          ...
          SizedBox(height: 20),
          Text('ברכת הלבנה:', style: TextStyle(color: Colors.blue.shade400)),
          Text('25 sept - 29 sept (noite incluida)', style: TextStyle(color: Colors.blue.shade400)),
          SizedBox(height: 20),
          Text('13 Tishrei'),
